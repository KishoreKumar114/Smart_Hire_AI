...
class PCG64(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001CB281E38A0>'
...
class PCG64DXSM(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001CB281E38D0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CB281F19C8>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._pcg64', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001CB281F19C8>, origin='C:\\\\Users\\\\Lenovo\\\\Desktop\\\\project\\\\SyntheticIdCardPy\\\\venv\\\\lib\\\\site-packages\\\\numpy\\\\random\\\\_pcg64.cp37-win_amd64.pyd')"
