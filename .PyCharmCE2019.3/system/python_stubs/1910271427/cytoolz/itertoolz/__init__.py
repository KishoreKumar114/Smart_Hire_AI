...
# from C:\Users\Lenovo\Desktop\project\SyntheticIdCardPy\venv\lib\site-packages\cytoolz\itertoolz.cp37-win_amd64.pyd
# by generator 1.147
# no doc
...
def get(ind, seq, default=None): # real signature unknown; restored from __doc__
    """
    get(ind, seq, default=u'__no__default__')
...
def join(leftkey, leftseq, rightkey, rightseq, left_default=None, right_default=None): # real signature unknown; restored from __doc__
    """
    join(leftkey, leftseq, rightkey, rightseq, left_default=u'__no__default__', right_default=u'__no__default__')
...
def partition(Py_ssize_t_n, seq, pad=None): # real signature unknown; restored from __doc__
    """
    partition(Py_ssize_t n, seq, pad=u'__no__pad__')
...
def pluck(ind, seqs, default=None): # real signature unknown; restored from __doc__
    """
    pluck(ind, seqs, default=u'__no__default__')
...
def reduceby(key, binop, seq, init=None): # real signature unknown; restored from __doc__
    """
    reduceby(key, binop, seq, init=u'__no__default__') -> dict
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020E9FF55808>'

__pyx_capi__ = {
    'c_diff': None, # (!) real value is '<capsule object "PyObject *(PyObject *, struct __pyx_opt_args_7cytoolz_9itertoolz_c_diff *__pyx_optional_args)" at 0x0000020E9FED5DB0>'
    'c_merge_sorted': None, # (!) real value is '<capsule object "PyObject *(PyObject *, struct __pyx_opt_args_7cytoolz_9itertoolz_c_merge_sorted *__pyx_optional_args)" at 0x0000020E9FED5900>'
    'concat': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5C00>'
    'cons': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5BD0>'
    'count': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5CF0>'
    'drop': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5A20>'
    'first': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5A80>'
    'frequencies': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5C60>'
    'get': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_get *__pyx_optional_args)" at 0x0000020E9FED5BA0>'
    'getter': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5D50>'
    'groupby': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5870>'
    'isdistinct': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5990>'
    'isiterable': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5960>'
    'join': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_join *__pyx_optional_args)" at 0x0000020E9FED5D80>'
    'last': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5B40>'
    'mapcat': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5C30>'
    'nth': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5AE0>'
    'partition': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_partition *__pyx_optional_args)" at 0x0000020E9FED5CC0>'
    'peek': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5E10>'
    'peekn': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5E40>'
    'pluck': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_pluck *__pyx_optional_args)" at 0x0000020E9FED5D20>'
    'reduceby': None, # (!) real value is '<capsule object "PyObject *(PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_reduceby *__pyx_optional_args)" at 0x0000020E9FED5C90>'
    'rest': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5B70>'
    'second': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5AB0>'
    'tail': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED59F0>'
    'take': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED59C0>'
    'take_nth': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch)" at 0x0000020E9FED5A50>'
    'topk': None, # (!) real value is '<capsule object "PyObject *(Py_ssize_t, PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_topk *__pyx_optional_args)" at 0x0000020E9FED5DE0>'
    'unique': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_7cytoolz_9itertoolz_unique *__pyx_optional_args)" at 0x0000020E9FED5930>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='cytoolz.itertoolz', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020E9FF55808>, origin='C:\\\\Users\\\\Lenovo\\\\Desktop\\\\project\\\\SyntheticIdCardPy\\\\venv\\\\lib\\\\site-packages\\\\cytoolz\\\\itertoolz.cp37-win_amd64.pyd')"
