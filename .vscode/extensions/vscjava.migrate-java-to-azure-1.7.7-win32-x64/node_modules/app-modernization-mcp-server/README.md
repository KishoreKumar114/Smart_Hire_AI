...
This tool (ID: `appmod-java-run-test`) runs tests in the Java project and reports any detected errors or test failures. It accepts a `workspacePath` parameter and returns test execution results with details about failures and errors encountered.
